    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">History of tasks you successfully completed and archived. Search by task, comment, or date.</p>
        </div>
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          filteredTasks.map((task) => (
            <TaskCard key={task._id} task={task} role="employee" onRefresh={loadArchive} />
          ))
        )}
      </div>
    </div>
